...
public class HangmanDriver
{
   ...
   /** Entry point of the program */
		...
		while(countErrors < 8){
			...
			*/
			if(guess.equalsIgnoreCase("MENU")){
				...
				Postcondition: Prints out how many guesses have been used
				*/
				if(found != 1){
					countErrors++;
			...
			Postcondition: breaks from loop
			*/
	...
	/*
	Precondition: countErrors, movie, and letterGuess are filled 
	Postcondition: Gallows is drawn depending on countErrors
	*/
	...
	/*
	Precondition: None except for program calling instructionMenu  
	Postcondition: instructions prints on screen
	*/
